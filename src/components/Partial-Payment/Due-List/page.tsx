...
const mockData: Fields[] = [
    {
        ...
        percentage: "25%",
        paid_amount: "73,602",
        due_amount: "220,806.97",
        remaining_day: "0",
        last_payment_date: "22-08-2024",
...
const DueList = () => {
    ...
    const fields: { label: string; key: keyof Fields }[] = [
        ...
        { label: 'Remaining Day', key: 'remaining_day' },
        { label: 'Last Payment Date', key: 'last_payment_date' },
                                ...
                                <tbody>
                                    {filteredData.map((item) => (
                                        <tr key={item.booking_id} className="hover:bg-gray-100 transition">
                                            ...
                                            <td className="py-2 px-4 border border-gray-300 text-sm text-center text-black whitespace-nowrap">{item.due_amount}</td>
                                            <td className="py-2 px-4 border border-gray-300 text-sm text-center text-black whitespace-nowrap">{item.remaining_day}</td>
                                            <td className="py-2 px-4 border border-gray-300 text-sm text-center text-black whitespace-nowrap">{item.last_payment_date}</td>
