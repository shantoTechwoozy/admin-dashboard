                                ...
                                <thead>
                                    <tr>
                                        {fields.map((field) => (
                                            <th
                                                key={field.key}
                                                className="py-5 px-3 bg-black border border-gray-300 cursor-pointer text-sm text-center hover:bg-gray-300 transition whitespace-nowrap"
                                ...
                                <tbody>
                                    {filteredData.map((item) => (
                                        <tr key={item.booking_id} className="hover:bg-gray-100 transition">
                                            ...
                                            <td className="py-2 px-4 border border-gray-300 text-sm text-center text-black whitespace-nowrap">{item.status}</td>
