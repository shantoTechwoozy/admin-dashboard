...
const menuGroups = [
  {
    ...
    menuItems: [
      {
        icon: (
          <FcSearch className="mr-2 text-blue-500" size={25} />
        ),
        label: "Dashboard",
        route: "#",
        children: [{ label: "Search Engine", route: "/search-engine" }],
      },
      {
        icon: (
      ...
      {
        icon: (
          <FaCreativeCommonsZero className="mr-2 text-red-500" size={25} />
      ...
      {
        icon: (
          <FcMoneyTransfer className="mr-2 text-orange-500" size={25} />
      ...
      {
        icon: (
          <GiReceiveMoney className="mr-2 text-green-500" />
      ...
      {
        icon: (
          <FcCurrencyExchange className="mr-2 text-blue-500" size={25} />
      ...
      {
        icon: (
          <HiBriefcase className="mr-2 text-gray-600" size={25} />
